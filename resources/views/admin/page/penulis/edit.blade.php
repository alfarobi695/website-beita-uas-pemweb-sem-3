...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-edit"></i> Edit Data Penulis</h3>
          </div>
          <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <i class="far fa-list-alt"></i> Form Edit Data Penulis</h3>
      ...
      action="{{ url('/penulis.'.$DataPenulis->id_penulis) }}"
      ...
      <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              is-invalid @enderror" name="penulis" 
              id="penulis" value="{{ $DataPenulis->penulis}}">
            </div>
          </div>
          @error('penulis')
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              id="email" value="{{ $DataPenulis->email}}">
            </div>
          </div>
          @error('email')
              <span class="text-danger">{{ $message }}</span>
