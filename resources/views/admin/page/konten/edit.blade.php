        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/konten')}}">Data konten</a></li>
...
<div class="card card-info">
  <div class="card-header">
    ...
    <div class="card-tools">
                  <a href="{{url('/konten')}}" class="btn btn-sm btn-warning float-right">
      ...
      action="{{ url('/konten.'.$DataKonten->id_konten) }}"
      ...
      <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              id="judul" value="{{ $DataKonten->judul}}">
            </div>
          </div>
          @error('judul')
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              id="tanggal" value="{{ $DataKonten->tanggal}}">
            </div>
          </div>
          @error('tanggal')
              <span class="text-danger">{{ $message }}</span>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              is-invalid @enderror" name="jenis" 
              id="jensi" value="{{ $DataKonten->jenis_konten}}">
            </div>
          </div>
          @error('jenis')
              <span class="text-danger">{{ $message }}</span>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7"> 
              ...
              is-invalid @enderror" 
              name="isi" id="isi" value="{{ $DataKonten->isi}}">{{ $DataKonten->isi}}</textarea>
            </div>
          </div>
