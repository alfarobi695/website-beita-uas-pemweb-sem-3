        ...
        <div class="card-body">
          <div class="form-group row">
           ...
           <span class="text-info">
            <i class="fas fa-user-circle"></i> <u>Data Berita</u>
            </span></label>
          </div>          
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              name="publisher" id="publisher" value="">
            </div>
          </div>
          @error('publisher')
              <span class="text-danger">{{ $message }}</span>
          ...
          <div class="form-group row">
            ...
            Penulis</label>
            <div class="col-sm-7">
              <select class="form-control  @error('penulis') 
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              ...
              is-invalid @enderror" name="keterangan_berita" id="editor1" 
              rows="12"></textarea>
            </div>
          </div>  
